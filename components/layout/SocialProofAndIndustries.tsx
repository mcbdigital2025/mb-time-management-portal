  ...
  return (
    <section className="w-full bg-white">
      ...
      <div className="w-full flex flex-col gap-6 items-center
                      ...
                      px-4 sm:px-8 lg:px-77.5">
        {/* Testimonials header */}
        <div className="text-center">
          <div className="text-[16px] text-gray-500">
            Trusted by service teams across Australia
          </div>
          <h2 className="text-[22px] sm:text-[24px] font-semibold text-[#1F1F1F]">
            Used by hundreds of managers daily
          </h2>
        </div>

        {/* Light panel */}
        <div className="mx-auto rounded-2xl w-full flex justify-center bg-[#F6F9FC]
                        px-4 py-6 sm:px-6">
            ...
            {testimonials.map((t, idx) => (
              <div
                ...
                className={`rounded-[10px] ${
                  idx === 0
                    ? "bg-white shadow-[0_8px_18px_rgba(15,23,42,0.06)] ring-1"
                    : "bg-transparent"
                } px-4 py-3 ring-black/5`}
              >
      ...
      <div className="w-full flex flex-col gap-6
        ...
        <div className="text-center space-y-6">
          ...
          <h3 className="text-[22px] sm:text-[24px] font-semibold text-[#1F1F1F]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {industries.map((c) => (
            <div
              key={c.title}
              className="rounded-2xl space-y-5 bg-white px-5 py-5 shadow-[0_10px_22px_rgba(15,23,42,0.06)] ring-1 ring-[#D9D9D9]"
            >
              <div
