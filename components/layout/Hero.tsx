...
export default function Hero() {
  return (
    <section
      ...
      // }}
    >
      <div className="mx-auto w-full max-w-378 py-25 px-56.5">
        {/* Top text block */}
        <div className="mx-auto flex max-w-265 max-h-68 flex-col items-center text-center">
          ...
          <h1 className="mt-6 text-[48px] leading-[1.1] font-semibold tracking-[-0.02em] text-black">
        ...
        <div className="relative mx-auto mt-10 max-w-265 max-h-144.5 bg-[#6EB2BC40]">
          ...
          {/* Left floating chip */}
          <div className="absolute -left-18 top-41.5 -translate-y-1/2">
            <div className="flex items-center gap-3 rounded-xl bg-white px-4 py-3 shadow-md ring-1 ring-black/5">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-emerald-50">
                <CircleCheck className="h-6 w-6 text-[#b7f085]" />
              </div>
              <div className="leading-tight">
                <div className="text-[12px]  text-[#8C8C8C]">Shift Status</div>
          ...
          {/* Right floating chip */}
          <div className="absolute left-247.75 top-93.75 -translate-y-1/2">
