...
export default function Hero() {
  return (
    <section className=" hero-radial-background w-full bg-[radial-gradient(12%_14.08%_at_9.42%_89.81%,#D1E5FF,#F8FAFC),radial-gradient(13.98%_18.61%_at_186.74%_119.73%,rgba(110,178,188,0.4),rgba(217,217,217,0.4))]">
      <div className="mx-auto w-full max-w-378 px-4 sm:px-8 lg:px-56.5 py-12 sm:py-16 lg:py-25">
        ...
        <div className="mx-auto flex w-ful max-w-265 max-h-68 flex-col items-center text-center">
          ...
          <p className=" text-sm leading-6 text-[#595959] md:w-104">
        ...
        <div className="relative mx-auto mt-10 max-w-265 max-h-144.5 bg-[#6EB2BC40]">
          <div className="w-full rounded-2xl bg-white p-3 shadow-[0_18px_60px_rgba(15,23,42,0.10)] ring-1 ring-black/5">
            <div className="relative overflow-hidden rounded-xl bg-gray-100">
              <Image
                ...
                height={900}
                priority
                className="h-auto w-full md:w-full select-none"
              />
            </div>
          </div>
          ...
          <div className="absolute md:-left-18 -left-3 md:top-41.5 top-12.5 -translate-y-1/2">
            <div className="flex items-center md:gap-3 rounded-xl bg-white px-1 md:px-4  py-1 md:py-3 shadow-md ring-1 ring-black/5">
              ...
              <div className="leading-tight">
                <div className="text-[8px] md:text-[12px]  text-[#8C8C8C]">
                  Shift Status
                </div>
          ...
          {/* Right floating chip */}
          <div className="absolute left-[85%] md:top-[75%] top-[70%] -translate-y-1/2">
            <div className="flex items-center gap-1 md:gap-3 rounded-xl bg-white px-1 md:px-2 py-2 md:py-3 shadow-md ring-1 ring-black/5">
              <div className="flex -space-x-2 w-8 md:w-18">
                {[
                  ...
                  <div
                    key={i}
                    className="h-4 md:h-7 w-4 md:w-7 rounded-full ring-2 ring-white overflow-hidden"
                  >
                    <Image
                      src={src}
                      alt="User avatar"
              ...
              <div className="leading-tight px-1 md:px-0 md:w-16">
                <div className="text-[5px] md:text-[12px] font-medium text-[#8C8C8C]">
                  Active Staff
                </div>
                <div className="text-[7px] md:text-sm font-semibold text-gray-900">
                  24 Online
                </div>
              </div>
            </div>
