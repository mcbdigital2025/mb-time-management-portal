...
const CreateUpdateIncidentReportModal = ({ user,
    clientBookingId,
    clientId,
    onClose,
    onSaved, }) => {
    ...
    useEffect(() => {
        if (clientBookingId) {
            ...
            setError("No shift reference found. Please select a shift.");
        }
    }, [clientBookingId, clientId]);
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="md:col-span-2 flex gap-4 mt-4">
                        <button
                            ...
                            className="flex-[2] bg-slate-900 text-white font-bold py-4 rounded-2xl hover:bg-black disabled:bg-slate-300 transition-all shadow-lg flex items-center justify-center gap-2 cursor-pointer"
                        >
                        ...
                        <button
                            type="button"
                            onClick={onClose}
                            className="flex-1 bg-white border-2 border-slate-200 text-slate-600 font-bold py-4 rounded-2xl hover:bg-slate-50 transition-all cursor-pointer"
                        >
                            Cancel
                        </button>
                    </div>
...
export default CreateUpdateIncidentReportModal;