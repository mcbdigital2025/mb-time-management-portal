  ...
  useEffect(() => {
    ...
    const loadDashboardData = async () => {
      ...
      try {
        ...
        // `/mcbtt/api/timesheet/clientschedule/staffid/${companyId}/${encodeURIComponent(empId)}`,
        ...
        if (response.ok) {
          ...
          console.log("🚀 ~ loadDashboardData ~ text:", text);
          const data = JSONbig.parse(text);
          console.log("🚀 ~ loadDashboardData ~ data:", data);
