            ...
            <div className="w-64 bg-white border-r border-slate-200 p-4 flex flex-col gap-2 shadow-sm">
                <div className="mb-6 px-2">
                    ...
                    <p className="text-[10px] text-slate-500 mt-1">
                        {selectedShift ? `Selected: ${selectedShift.clientName}` : 'Select a shift to enable menus'}
                    </p>
                </div>
                ...
                <button disabled={!selectedShift} onClick={() => navigateTo('/notes/add')} className={`${menuBtnClass(!!selectedShift)} hover:text-blue-700 hover:bg-blue-50`}><StickyNote size={18} /> Add Notes</button>
                                ...
                                >
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-slate-500 mt-1 flex items-center gap-1">
                                            <MapPin size={14} className="text-slate-400" /> {shift.facilitiesName || "No Location Listed"}
                                        </p>
                                        <p className="text-sm text-slate-500 mt-1 flex items-center gap-1">
                                            <Clock size={14} className="text-slate-400" /> {shift.scheduledStart} - {shift.scheduledEnd}
                                        </p>
                                    </div>
