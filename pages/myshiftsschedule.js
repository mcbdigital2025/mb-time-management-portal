...
const MyShiftsSchedule = ({ user }) => {
    ...
    // --- Helper: Updated to return true for "00:00" and "00:00:00" ---
    ...
    const filteredSchedules = useMemo(() => {
        ...
        return schedules.filter((s) => {
            // Updated to use workDate from the Java model
    ...
    // --- Action Handlers: Using System Time ---
                                ...
                                >
                                    ...
                                    <div className="flex flex-col items-end gap-2">
                                        ...
                                        <div className="flex flex-col text-[10px] font-bold text-right space-y-0.5">
                                           ...
                                           <div className="text-emerald-600">Clock In: {shift.actualStartTime}</div>
                                           <div className="text-rose-600">Clock Out: {shift.actualEndTime}</div>
                                        </div>
                                    </div>
                                </div>
                            ))
